    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">React Interview Questions</h1>
          <p className="text-lg text-gray-600">
            {reactQuestion.length} curated questions to prepare for your next interview
          </p>
        </div>
        ...
        <div className="mb-8 bg-white p-4 rounded-lg shadow">
          ...
          <div className="text-sm text-gray-500">
            Showing {filteredQuestions.length} of {reactQuestion.length} questions
          </div>
        </div>
              ...
              <div key={q.id} className="bg-white overflow-hidden shadow rounded-lg">
                ...
                {expandedId === q.id && (
                  <div className="px-4 py-5 sm:p-6 border-t border-gray-200">
                    <div className="prose max-w-none">{renderAnswer(q.answer)}</div>
                  </div>
                )}
              </div>
            ))
