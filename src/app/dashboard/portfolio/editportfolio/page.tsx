...
const Page = () => {
  ...
  const handleAddStack = () => {
    ...
    const alreadyExists = editData.techstack.some(
      (item) => item.name.toLowerCase() === (matchedItem?.name || newStack.name).toLowerCase(),
    );
                        ...
                        >
                          <div className="absolute top-2 right-6">
                            <Button
                              ...
                              variant="destructive"
                              size="sm"
                              onClick={() => removeExperiences(exp.id)}
                        ...
                        {editData.techstack.map((item) => (
                          ...
                          >
                            <span className="flex space-x-1 items-center">
                              {item.logo ? (
                                <img src={item.logo} alt={item.name} className="w-4 h-4" />
                              ) : (
                            ...
                            <span onClick={(e) => removeStack(item.name)}>
              ...
              {currentTab === 'certification/courses' && (
                <CardContent className="space-y-6">
                  {editData.certifications.map((cert) => (
                    <motion.div key={cert.id} layout className="p-4 border rounded-lg space-y-4">
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleCertificationChange(cert.id, 'description', e.target.value)
                          }
                          rows={2}
                        />
                      </div>
                ...
                <CardContent className="p-4">
                  ...
                  >
                    <div>
                      ...
                      <Select value={editData?.availability} onValueChange={setAvailability}>
