...
const Page = () => {
  ...
  const getChatChannelName = (id1: string, id2: string) => `chat:${[id1, id2].sort().join('-')}`;
        ...
        {messages.map((message) => (
          ...
          >
            ...
            >
              ...
              <p
                className={`text-xs mt-1 text-right ${message.sender === 'user' ? 'text-primary-foreground/70' : 'text-muted-foreground'}`}
              >
