      ...
      <Card className='max-w-xl w-full  mx-auto overflow-hidden relative'>
        ...
        <CardContent className="relative min-h-[200px] px-6 py-4">
          <AnimatePresence custom={direction} initial={false}>
            ...
            >
              <div>
                <h3 className='font-semibold mb-4 text-xl text-gray-800'>{currentQuestion.question}</h3>
                <div className={cn("space-y-3 max-h-[280px] pr-2 overflow-y-auto custom-scrollbar")}>
