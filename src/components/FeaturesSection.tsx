...
import { ShieldCheck, BookOpen, Briefcase, Users, LayoutDashboard, Store } from 'lucide-react';
...
const features = [
  {
    ...
    description: (
      <>
        <span className="text-blue-600 font-medium">Private Vault:</span> AES-256 encryption
        <br />
        <span className="text-blue-600 font-medium">Public Showcase:</span> Share selectively with
        500k+ devs
  ...
  },
  {
    ...
    description: (
      <>
        <span className="text-purple-600 font-medium">Private Drafts:</span> Perfect your articles
        <br />
        <span className="text-purple-600 font-medium">Public Blogs:</span> Build authority in your
        stack
        <div className="mt-3 text-sm text-purple-600">✦ 68% reader engagement boost</div>
      </>
    ),
    bg: 'bg-purple-50',
  },
  {
    ...
    description: (
      <>
        ...
        <div className="mt-3 text-sm text-green-600">✦ 40% faster job placement</div>
      </>
    ),
    bg: 'bg-green-50',
  },
  {
    ...
    description: (
      <>
        ...
        <div className="mt-3 text-sm text-yellow-600">✦ 2.5x faster debugging</div>
      </>
    ),
    bg: 'bg-yellow-50',
  },
  {
    ...
    description: (
      <>
        ...
        <div className="mt-3 text-sm text-red-600">✦ 3x more interview requests</div>
      </>
    ),
    bg: 'bg-red-50',
  },
  {
    ...
    description: (
      <>
        ...
        <div className="mt-3 text-sm text-indigo-600">✦ $2.8M paid to devs (Beta Waitlist)</div>
      </>
    ),
    bg: 'bg-indigo-50',
  },
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600">
            92% of developers report increased productivity within 30 days of using CodeVault
          </p>
        </div>
          ...
          {features.map((feature, idx) => (
            ...
            >
              ...
              <CardContent className="text-center">
                <CardTitle className="text-gray-900 mb-3">{feature.title}</CardTitle>
        ...
        <div className="mt-16 text-center">
          ...
          >
            <span className="mr-2 group-hover:mr-3 transition-all">Start Your Success Journey</span>
            <svg
